...
class DeepEyedentification2Diffs():
    ...
    def __init__(
        ...
        self.slow_subnet, self.fast_subnet, self.model = DeepEyedentification2Diffs.build_deepeyedentification(
            seq_len,
            channels,
            config_slow,
            config_fast,
    ...
    def build_deepeyedentification(
        ...
        opt_deepeyedentification = tensorflow.keras.optimizers.Adam(
            lr=config_deepeyedentification.learning_rate,
        )
    ...
    def build_slow_subnet(seq_len, channels, Nreader, config, zscore_mean_vel_diffs, zscore_std_vel_diffs):
        ...
        slow_p1 = AveragePooling1D(
            pool_size=config.pl_size[0], strides=config.pl_strides[0], padding='same', name='slow_p1',
        )(slow_a1)
        ...
        slow_p2 = AveragePooling1D(
            pool_size=config.pl_size[1], strides=config.pl_strides[1], padding='same', name='slow_p2',
        )(slow_n2)
        ...
        slow_p3 = AveragePooling1D(
            pool_size=config.pl_size[2], strides=config.pl_strides[2], padding='same', name='slow_p3',
        )(slow_n3)
        ...
        slow_p4 = AveragePooling1D(
            pool_size=config.pl_size[3], strides=config.pl_strides[3], padding='same', name='slow_p4',
        )(slow_n4)
        ...
        slow_p5 = AveragePooling1D(
            pool_size=config.pl_size[4], strides=config.pl_strides[4], padding='same', name='slow_p5',
        )(slow_n5)
        ...
        slow_p6 = AveragePooling1D(
            pool_size=config.pl_size[5], strides=config.pl_strides[5], padding='same', name='slow_p6',
        )(slow_n6)
        ...
        slow_p7 = AveragePooling1D(
            pool_size=config.pl_size[6], strides=config.pl_strides[6], padding='same', name='slow_p7',
        )(slow_n7)
        ...
        slow_p8 = AveragePooling1D(
            pool_size=config.pl_size[7], strides=config.pl_strides[7], padding='same', name='slow_p8',
        )(slow_n8)
        ...
        slow_p9 = AveragePooling1D(
            pool_size=config.pl_size[8], strides=config.pl_strides[8], padding='same', name='slow_p9',
        )(slow_n9)
    ...
    def build_fast_subnet(seq_len, channels, Nreader, config, zscore_mean_vel_diffs, zscore_std_vel_diffs):
        ...
        fast_p1 = AveragePooling1D(
            pool_size=config.pl_size[0], strides=config.pl_strides[0], padding='same', name='fast_p1',
        )(fast_a1)
        ...
        fast_p2 = AveragePooling1D(
            pool_size=config.pl_size[1], strides=config.pl_strides[1], padding='same', name='fast_p2',
        )(fast_n2)
        ...
        fast_p3 = AveragePooling1D(
            pool_size=config.pl_size[2], strides=config.pl_strides[2], padding='same', name='fast_p3',
        )(fast_n3)
        ...
        fast_p4 = AveragePooling1D(
            pool_size=config.pl_size[3], strides=config.pl_strides[3], padding='same', name='fast_p4',
        )(fast_n4)
        ...
        fast_p5 = AveragePooling1D(
            pool_size=config.pl_size[4], strides=config.pl_strides[4], padding='same', name='fast_p5',
        )(fast_n5)
        ...
        fast_p6 = AveragePooling1D(
            pool_size=config.pl_size[5], strides=config.pl_strides[5], padding='same', name='fast_p6',
        )(fast_n6)
        ...
        fast_p7 = AveragePooling1D(
            pool_size=config.pl_size[6], strides=config.pl_strides[6], padding='same', name='fast_p7',
        )(fast_n7)
        ...
        fast_p8 = AveragePooling1D(
            pool_size=config.pl_size[7], strides=config.pl_strides[7], padding='same', name='fast_p8',
        )(fast_n8)
        ...
        fast_p9 = AveragePooling1D(
            pool_size=config.pl_size[8], strides=config.pl_strides[8], padding='same', name='fast_p9',
        )(fast_n9)
